...
// Suppress warnings immediately on module load
...
// Extend the Crypto interface to include randomBytes
declare global {
  interface Crypto {
    ...
    globalThis.crypto = {
      getRandomValues: <T extends ArrayBufferView>(array: T): T => {
        if (
          ...
          try {
            ...
            // Fallback for Expo Go: Use crypto-js for random values
      ...
      randomBytes: async size => {
        try {
          ...
          // Fallback for Expo Go: Use crypto-js
